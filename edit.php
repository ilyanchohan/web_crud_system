...
<title>Edit Entry — Directory</title>
...
h1 { font-size: 1.5rem; font-weight: 700; margin: 0 0 1.5rem; color: #0f172a; }
...
.btn-primary { background: #334155; color: #fff; margin-top: 0.5rem; width: 100%; }
...
<div class="wrap">
  ...
  <form action="" method="post">
    ...
    <div class="form-group">
      ...
      <input type="number" id="age" name="age" value="<?php echo htmlspecialchars($row['age']); ?>" required min="1" max="120">
    </div>
    <div class="form-group">
  ...
  <p class="footer-links"><a href="VIEW.php" class="btn btn-secondary">Back to Directory</a></p>
</div>
</body>
</html>